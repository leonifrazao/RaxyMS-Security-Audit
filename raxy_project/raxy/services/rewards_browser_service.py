...
from raxy.interfaces.services import IRewardsBrowserService
    ...
    def _login(driver: Driver, data: Mapping[str, object] | None = None) -> BaseRequest:
        ...
        if driver.run_js("return document.title").lower() == "microsoft rewards":
            ...
            registro.debug(
                ...
                total_cookies=len(base_request.cookies),
                token_encontrado=bool(base_request.token_antifalsificacao)
            )
            return base_request
